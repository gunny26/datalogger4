...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        self.project = self.datalogger.get_projects()[0]
        self.tablename = self.datalogger.get_tablenames(self.project)[0]
    ...
    def test_get_tablenames(self):
        data = self.datalogger.get_tablenames(self.project)
        self.assertTrue(isinstance(data, list))
